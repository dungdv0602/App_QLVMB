...
public class Fragment_DoiMK_staff extends Fragment {
            ...
            public void onClick(View v) {
                if (check()) {
                    if (edt_newpass.getText().toString().equals(edt_retype_newpass.getText().toString())) {
                        ...
                        dao_nv = new DAO_QLNV(getContext());
                        if (dao_nv.updatePW(user, edt_oldpass.getText().toString(), edt_newpass.getText().toString())) {
